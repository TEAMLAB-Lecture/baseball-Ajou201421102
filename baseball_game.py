...
def is_duplicated_number(three_digit):
    ...
    result = three_digit
    strlist = list(result)
    if strlist[0]==strlist[1] or strlist[0]==strlist[2] or strlist[1]==strlist[2]:
        return True
    else:
        return False
    # ==================================
...
def is_validated_number(user_input_number):
    ...
    if is_digit(num) and is_between_100_and_999(num) and not is_duplicated_number(num):
        return True
    else:
        return False
    # ==================================
...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    user = list(str(user_input_number))
    num = list(str(random_number))
    strike = 0
    ball = 0
